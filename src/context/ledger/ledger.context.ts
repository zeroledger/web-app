...
export const LedgerContext = createContext<{
  ...
  connectionWalletPreference: boolean | null;
  setConnectionWalletPreference: (v: boolean) => void;
  resetConnectionWalletPreference: () => void;
  ...
  connectionWalletPreference: null,
